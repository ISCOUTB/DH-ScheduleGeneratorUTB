...
--
-- Data for Name: clase; Type: TABLE DATA; Schema: public; Owner: pg_database_owner
--

COPY public.clase (nrc, horainicio, horafinal, aula, dia, id) FROM stdin;
\.


--
-- Data for Name: curso; Type: TABLE DATA; Schema: public; Owner: pg_database_owner
--

COPY public.curso (nrc, tipo, codigomateria, profesorid, nrcteorico, groupid, campus, cuposdisponibles, cupostotales) FROM stdin;
\.


--
-- Data for Name: materia; Type: TABLE DATA; Schema: public; Owner: pg_database_owner
--

COPY public.materia (codigomateria, creditos, nombre) FROM stdin;
\.


--
-- Data for Name: profesor; Type: TABLE DATA; Schema: public; Owner: pg_database_owner
--

COPY public.profesor (bannerid, nombre) FROM stdin;
\.


--
-- Name: clase_id_seq; Type: SEQUENCE SET; Schema: public; Owner: pg_database_owner
--
